    ...
    return (
        <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                ...
                <Card>
                    <CardHeader className="py-2">
                        <CardTitle className="text-xs font-medium text-amber-500 uppercase">
                            Sent to Supplier
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="py-2">
            ...
            >
                <div className="flex w-full gap-2 sm:flex-1">
                    ...
                    {(search || status !== 'all' || supplierId !== 'all') && (
                        <Button
                            type="button"
                            variant="ghost"
                ...
                <div className="flex w-full gap-2 sm:w-auto">
                    ...
                    <select
                        ...
                        onChange={(e) => {
                            ...
                            handleFilterChange(search, status, e.target.value);
                        }}
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 gap-4 border-y py-4 text-sm md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-foreground">
                                        {selectedPO.purchase_request?.purpose}
                                    </p>
                                </div>
                                <div>
                                    <p className="font-semibold text-muted-foreground">
