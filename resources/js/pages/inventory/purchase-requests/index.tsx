                    ...
                    <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                        ...
                        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Specify procurement details and line items.
                                    Estimates are based on catalog values.
                                </DialogDescription>
                            </DialogHeader>
                            <form
                    ...
                    {selectedPR && (
                        <>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Filed on{' '}
                                    {formatDateTime(selectedPR.created_at)} by{' '}
                                    {selectedPR.requester?.name}
                                </DialogDescription>
                            </DialogHeader>
